...
Column {
    ...
    Item {
        ...
        ComboBox {
            ...
            popup: Popup {
                ...
                background: Rectangle {
                    ...
                    opacity: 0.96
                    border.width: 1
                    border.color: config.FieldBorderColor || "transparent"
                }
        ...
        TextField {
            ...
            background: DarkAgesBar {
                // plain row with a hairline at rest, teal spear-tip bar when focused
                fillColor: config.LoginFieldBackgroundColor
                borderColor: config.HighlightBorderColor
                ruleColor: config.FieldBorderColor || "transparent"
                ruleInset: 0
                barOpacity: 0
            }
    ...
    Item {
        ...
        Button {
            ...
            background: DarkAgesBar {
                ...
                // hairline row while disabled, the orange "Start Game" bar once a password is typed
                fillColor: config.LoginButtonBackgroundColor
                borderColor: config.LoginButtonBorderColor || config.LoginButtonBackgroundColor
                ruleColor: config.FieldBorderColor || "transparent"
                ruleInset: 0
                barOpacity: 0
            }
            ...
            states: [
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        barOpacity: 1
                        fillColor: Qt.lighter(config.LoginButtonBackgroundColor, 1.25)
                        borderColor: Qt.lighter(config.LoginButtonBorderColor || config.LoginButtonBackgroundColor, 1.15)
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
                        opacity: 1
                ...
                State {
                    ...
                    PropertyChanges {
                        target: buttonBackground
                        barOpacity: 1
                        fillColor: Qt.lighter(config.LoginButtonBackgroundColor, 1.35)
                        borderColor: Qt.lighter(config.LoginButtonBorderColor || config.LoginButtonBackgroundColor, 1.2)
                    }
                    PropertyChanges {
                        target: loginButton.contentItem
                        opacity: 1
            ...
            transitions: [
                Transition {
                    PropertyAnimation {
                        properties: "opacity, color, fillOpacity, fillColor, borderColor, barOpacity";
                        duration: 300
                    }
                }
            ]
