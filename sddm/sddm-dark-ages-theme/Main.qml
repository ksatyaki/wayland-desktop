...
Pane {
    ...
    // the theme's serif; loaded from the theme dir so the greeter finds it even before the install script copies it to /usr/share/fonts
    FontLoader { source: Qt.resolvedUrl("Fonts/Cormorant/Cormorant-Regular.otf") }
    FontLoader { source: Qt.resolvedUrl("Fonts/Cormorant/Cormorant-Medium.otf") }
    FontLoader { source: Qt.resolvedUrl("Fonts/Cormorant/Cormorant-SemiBold.otf") }
    FontLoader { source: Qt.resolvedUrl("Fonts/Cormorant/Cormorant-Bold.otf") }
    FontLoader { source: Qt.resolvedUrl("Fonts/Cormorant/Cormorant-Italic.otf") }
    FontLoader { source: Qt.resolvedUrl("Fonts/Cormorant/Cormorant-MediumItalic.otf") }
